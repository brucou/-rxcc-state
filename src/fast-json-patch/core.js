 ...
 */
export function applyOperation(document, operation, validateOperation = false, mutateDocument = true) {
 ...
 */
export function applyPatch(document, patch, validateOperation, mutateDocument = true) {
  if(validateOperation) {
